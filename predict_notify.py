...
"""
import sys, io, os, json, requests as req_lib, argparse
...
from predict import load_input, ana_candidates, fukusho_candidates
...
FUKUSHO_PARAMS = {
    ...
    'count_max': 15, 'kelly_pct': 0.030, 'kelly_max': 15000,
}
...
def main():
    ...
    print(f'{len(races_hist)}レース / 馬{len(prev_history)}頭 読み込み完了')
    ...
    ana_cands = ana_candidates(races_input, capital)
    fuk_cands = fukusho_candidates(races_input, prev_history, capital)
